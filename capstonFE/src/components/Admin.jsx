...
//                     }
//                 };
//                 const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/users/admin/data`, config);
//                 setUsers(res.data.users); // Assuming the response contains a 'users' array
//             } catch (err) {
//                 console.error(err);
//             }
//         };
